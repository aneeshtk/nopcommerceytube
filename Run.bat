rem chrome browser
rem pytest -v -s -m "sanity" --html=Reports\grouping_sanity_or_regression_report.html --capture=tee-sys testcases\ --browser chrome
pytest -v -s -m "sanity or regression" --html=Reports\grouping_sanity_or_regression_report.html --capture=tee-sys testcases\ --browser chrome
